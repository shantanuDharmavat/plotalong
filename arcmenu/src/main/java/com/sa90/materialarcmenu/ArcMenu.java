...
public class ArcMenu extends FrameLayout {
    private static final double POSITIVE_QUADRANT = 80;
...
//    };
    ...
    public ArcMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray attr = context.obtainStyledAttributes(attrs, com.sa90.materialarcmenu.R.styleable.ArcMenu, 0, 0);
        init(attr);
    ...
    private void init(TypedArray attr) {
        ...
        mDrawable = attr.getDrawable(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_scr);
        mColorStateList = attr.getColorStateList(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_color);
        mFinalRadius = attr.getDimension(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_radius,
                resources.getDimension(com.sa90.materialarcmenu.R.dimen.default_radius));
        mElevation = attr.getDimension(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_elevation,
                resources.getDimension(com.sa90.materialarcmenu.R.dimen.default_elevation));
        mMenuSideEnum = MenuSideEnum.fromId(attr.getInt(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_open, 0));
        mAnimationTime = attr.getInteger(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_animation_time, ANIMATION_TIME);
        mCurrentRadius = 0;
        ...
        mRippleColor = attr.getColor(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_ripple_color, getThemeAccentColor(getContext(), com.sa90.materialarcmenu.R.attr.colorControlHighlight));

        if (mColorStateList == null) {
            mColorStateList = ColorStateList.valueOf(getThemeAccentColor(getContext(), com.sa90.materialarcmenu.R.attr.colorAccent));
        }
        ...
        menuMargin = attr.getDimensionPixelSize(com.sa90.materialarcmenu.R.styleable.ArcMenu_menu_margin,
                resources.getDimensionPixelSize(com.sa90.materialarcmenu.R.dimen.fab_margin));
    }
...
//        fabMenu.setOnClickListener(mMenuClickListener);
    ...
    public int getVisibility() {
        return fabMenu.getVisibility();
    }

    public void setVisibility(int value) {
        fabMenu.setVisibility(value);
        invalidate();
    }
